...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-01-2026 a las 10:29:31
...
INSERT INTO `pedidos` (`id`, `id_cliente`, `id_producto`, `fecha_inicio`, `fecha_final`, `precio_total`, `estado`, `creado`) VALUES
(14, 5, 4, '2004-12-12', '2020-12-12', 213456, 'Pendiente', '2026-01-12');
...
(12, 'suda', 'gytr', 6, 12, 1, 'sudadera', '2025-12-17 10:23:29');
...
INSERT INTO `usuarios` (`id`, `email`, `password`, `rol`, `nombre`, `creado`) VALUES
(1, 'oliverdominguezmoreno@gmail.com', 'f7c3bc1d808e04732adf679965ccc34ca7ae3441', 1, 'Alfredo', '2025-12-01 10:29:52'),
(6, 'jerib@gmail.com', 'asdqwrtyjhnbvccuyjhnbvcvc', 1, 'jeriberto', '2026-01-12 09:34:28'),
