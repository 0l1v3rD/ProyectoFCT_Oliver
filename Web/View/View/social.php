...
<body>
    <div id="header"></div>
    <main>
        <p class="ms-3 mt-2"><a title="Inicio" href="index.php">Inicio</a> > <a title="Social" href="social.php">Social</a></p>
        <div class="container d-flex flex-column text-center justify-content-around">
            <h1>En proceso...</h1>
            <h2>Ahora mismo no tenemos redes sociales.</h2>
            <img class="align-self-center" src="img/mountain.png" width="500px" alt="Montaña">
        </div>
    </main>
    <div id="footer"></div>
</body>
